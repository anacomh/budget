    ...
    <div class="frame d-flex">
      <div class="row justify-content-center">
        <div class="col-10 m-col8 s-col12">
          <span class="data-info"><?php echo $mainDetails->prop_local; ?>, <?php echo date('d M Y', strtotime($mainDetails->prop_time)); ?></span>

          <h1>Proposta de Trabalho: <?php echo $mainDetails->client_name; ?></h1>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-10 m-col8 s-col12">
        ...
        <h2><?php echo $mainDetails->prop_name; ?></h2>
        <p><?php echo $mainDetails->prop_text; ?></p>
      </div> <!-- Fim colunas -->
    </div><!--  fim row -->
  </div><!-- fim container -->
